...
Before opening Android Studio, follow [live caption setup and verification](docs/live-captions.md) to extract the committed native runtime archive and download the models.
