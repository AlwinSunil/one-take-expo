...
export function normalizeProject(value: unknown): Project {
  ...
  if (p.scriptLines?.some(line => !line || typeof line.id !== 'string' || typeof line.spokenText !== 'string' || !Array.isArray(line.actionCues))) throw new Error('Project script lines are unreadable.');
